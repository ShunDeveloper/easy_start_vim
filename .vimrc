...
" Glyph settings
" This creates an auto command group called "my-glyph-palette" that applies a glyph palette to the NERDTree plugin. It applies the glyph palette when the file type is "nerdtree" or "startify".
...
let g:airline#extensions#default#layout = [ " set the default layout for airline
  \ [ 'a', 'b', 'c' ], " set the sections in the left part of airline
  \ ['z'], " set the sections in the right part of airline
  \ ]
